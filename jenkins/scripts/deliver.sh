...
echo 'The following "npm" command builds your Node.js application for'
echo 'production in the local "build" directory (i.e. within the'
echo '"/var/jenkins_home/workspace/node-app" directory),'
...
echo 'The following "npm" command runs your node.js application in'
